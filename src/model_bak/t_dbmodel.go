...
// 获取一个model对象
func GetModel(sqlController SqlController) (T_model,error){
	if sqlController.TableName==""{
		return T_model{},fmt.Errorf("请配置TableName！")
	}
	if sqlController.InsertColumns==nil{
		return T_model{},fmt.Errorf("InsertColumns为空")
	}
	if sqlController.QueryColumns==nil{
		return T_model{},fmt.Errorf("QueryColumns为空")
	}
	if sqlController.InSertFields ==nil{
		return T_model{},fmt.Errorf("CFMap为空")
	}
	...
	return T_model{sc:sqlController},nil
}
// 获取表名
func (m *T_model) GetTableName() string {
	return m.sc.TableName
}
// 设置插入列
func (m *T_model) SetInsertColumns(columns []string,insertFileds func(obj interface{}) []interface{}){
...
// 设置搜索列
func (m *T_model) SetQueryColumns(columns []string){
...
// 插入操作
func (m *T_model) Insert(obj interface{}) (err error) {
 ...
 */
func (m *T_model) Query(condiAOrderALimit string, args ...interface{}) (result []interface{}, err error) {
...
args: 5 'cjwddz'
 */
func (m *T_model) Count(condition string,args ...interface{}) (count int, err error) {
	count = 0
...
args: 3 'cjwddz' 5
 */
func (m *T_model) Update(setAndCondition string,args ...interface{}) (err error) {
